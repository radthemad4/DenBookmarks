...
export const feats: Entry[] = [
    ...
    },
    {
        ...
        author: 'Kaelik',
        link: 'http://tgdmb.com/phpBB3/viewtopic.php?p=144442#p144442',
    },
    ...[
    ...
    }),
    {
        ...
        author: "Wiseman",
        link: "http://www.tgdmb.com/phpBB3/viewtopic.php?p=282916#p282916",
    },
    {
        name: "Product of Celestial Dalliance [Celestial]",
        author: "Draculmaulkee",
        link: "http://www.tgdmb.com/phpBB3/viewtopic.php?p=151041#p151041",
    },
    {
    ...
    ...[
        ...
        return {
            name,
            author: 'virgil',
            link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=165139#p165139',
        }
    }),
    ...[
        ...
        return {
            name,
            author: 'Emerald',
            link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=127717#p127717',
        }
    }),
    {
        name: 'Blinding Strike [Ambush]',
        author: 'Apalala',
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=127798#p127798',
    },
    ...[
        'Rend Armor [Ambush]',
        'Bane Strike [Ambush]',
        ...
        return {
            name,
            author: 'Apalala',
            link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=128001#p128001',
        }
    }),
    {
        name: 'Rune Forging',
        author: 'God_of_Awesome',
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?f=6&t=50576',
    },
    {
        name: 'Theurgic Training [Paladin]',
        author: 'Crissa',
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?f=6&t=50565',
    },
    {
        name: 'Warmage Focus [General]',
        author: 'JonSetanta',
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?f=6&t=50002',
    },
    ...[
        ...
        return {
            name,
            author: 'Shokorai',
            link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=63888#p63888',
        }
    }),
    ...[
    ...
    }),
    {
        ...
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=58541#p58541',
    },
    ...[
        'Wild Attack [Combat]',
        ...
        return {
            name,
            author: 'NoDot',
            link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=40246#p40246',
        }
    }),
    {
        name: 'Improved Explosions [Metamagic]',
        author: 'JonSetanta',
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?f=6&t=40044',
    },
    ...[
        ...
        return {
            name,
            author: 'virgil',
            link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=39457#p39457',
        }
    }),
    ...[
    ...
    }),
    {
        name: 'Phalanx Wall',
        author: 'virgil',
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?f=6&t=39113',
    },
    {
        name: 'Dodge [General]',
        author: 'I_mongo',
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=37971#p37971',
    },
    ...[
        ...
        return {
            name,
            author: 'Lago_AM3P',
            link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=37859#p37859',
        }
    }),
    ...[
    ...
    }),
    {
        ...
        link: 'http://www.tgdmb.com/phpBB3/viewtopic.php?p=441472#p441472',
        author: 'Prak',
    },
    {
        name: "Energy Strike [Celestial (Outsider?)]",
        author: "For Valor",
        link: "http://www.tgdmb.com/phpBB3/viewtopic.php?p=144806#p144806",
    },
    {
        name: "Chitin Creator [Vermincrafting]",
        author: "Prak",
        link: "http://www.tgdmb.com/phpBB3/viewtopic.php?p=555354#p555354",
    },
    {
        name: "Shadow-Stuff [A Feat Per Level]",
        author: "Prak",
        link: "http://www.tgdmb.com/phpBB3/viewtopic.php?p=555767#p555767",
    },
    {
        name: "Polarized Fear Energy [Feat]",
        author: "Kaelik",
        link: "https://lh3.googleusercontent.com/fife/AK0iWDxFL_JbrxXaA6ZmqwpK7MtfU_FqyNpvg8RnIHTjCD3a67PSNXyx97sM6Imo8bC40YLTBecdvKiHePNQbgjdb9anSAuuZwzvEJU9XfwxRAyd5szT-Pv1fxMujpFyZW_HtjHnMpWY2XPjT-WehHHZSW-rF2GozQO5X2Lnz5ltJEDCEW54ddKwbW17KYqOzANYLNqKpoGlkLvPwjURJ2OUalNX0Ngo_MG4dqfLwYbIGyZ9c5rYweJSOn-S4bFnT4Koe0JzJRTAL0TUmKVp6RHzQp3U4PsCF3OgiugP5bLKU6W79Z3oBs8ykhnKiDL6VtSM54Gb0dpIst0mKe0-x4eKKI9_GmL-AOvbyZz3Dd-tb8XsBJl3F46vTX5grfTVqRCjoZcl07tXhEbztha30CNK8yW05sNszlyABCBufePPprO5RM9BbjvvAPSUNawIm9t7_IOe9IxQTmF3AhU0aUYfy9bqBhn8OCDI3RqSXfAusTp9i6oVgQ8aJg8evkTcrvpyzwrd246yFtEVbIVywbpf8cUXO7h1SKFuoErKGLtU0iq5J_PM2zF_OKIABrqY7rAffHsjJqEybOhMI-4opNT0-s6fcsmYm03uuaADmmVDQeArikdA7hmI45ypLAOwTq6FEV8JbmvjAEPEQ7g3PYGlcf4vRE2c5iWaIvGwhoyRfUYbwovBJ8grj84OSODEbvL-GqB2TwQoebTlT4eDSY6KiO41L3fnoERFywWzQoe2oTtkUdK5mSV2osUMTKQYua8hAr4QaZ0lY_d6N9BuWGZ8rs8EilPCZUnx_8kK-OE79VAlgHcv-txLs5gixfzY_FBsj_lJa-HvXv8QYI4imUnQAbBIPzjsNCiGmwYDt1khKMwIIQqcmgQcYAK3PJdERPBYUwWsWbK3Rq2Jo2Xm-eZS_WBh-BhEkS-G58wZ1ouYYhJVs9u5p-t7diV901WvrWLOeqtDNHrqhNUDCEXtajGMqf8bT8SktCf3EGYsgep2I2JHxfdZBQMHoAssJ-GbFltxDtPG2pMy65EWW7iRodTTq-LIeGBSQgnyp36h08oI-qS-Iwm-KgoM0r-UY44UUN0ZvRr6ad7poxwjFmJfCu2wV15EgCjSCCQUyVfdC6YJkNcNtBKOhxWXVDTFon9eNQUU-lmEATN5-Dg9Dgm90vZqx7PQxtFiRFxve234ncJnWqXxPm-4TCegvucSpPArroC6Ah26Xz2yOZMnYKwIdSyr2f3XzJUSzS1NwnDXmHRMowdCjOZW1W6otCEn02tmHXbuGWIaX2CEY16XYcA7UXB38FmOpBVuKwBQFXsRp_D3NMxlLitGrqLFg2b5jH2_9iAJR4vh3_IdquyvB-FEuWaqZAfPYUTlBIILXOArCcv3Ao59eX2ayxs7VopsPk-35OZFbeaYl8aY3G3hZNZnNCH-QqAKlfI5S0jJ5-MAj42Rh2nREckRZNdw43G2VIo7wEiXizWp3XmShD839FcJWJe5QFjfH06LRzQ-8kV4En-_xcxFSGtGIOmhBlE=w1600-h775",
    },
    ...[
